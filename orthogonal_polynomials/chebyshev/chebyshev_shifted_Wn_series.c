////////////////////////////////////////////////////////////////////////////////
// File: chebyshev_shifted_Wn_series.c                                        //
// Routine(s):                                                                //
//    Chebyshev_Shifted_Wn_Series                                             //
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
// double Chebyshev_Shifted_Wn_Series(double x, double a[], int degree)       //
//                                                                            //
//  Description:                                                              //
...
//     polynomials of the fourth kind, W*n, at a point x,                     //
//     p(x) = a[0] + a[1]*W*[1](x) + a[2]*W*[2](x) + ... + a[deg]*W*[deg](x). //
//                                                                            //
//     Clenshaw's recursion formula applied to shifted Chebyshev polynomials  //
//     of the fourth kind is:                                                 //
//     Set y[degree + 2] = 0, y[degree + 1] = 0, then for k = degree, ..., 1  //
//     set y[k] = (4*x - 2) * y[k+1] - y[k+2] + a[k].  Finally                //
//     set y[0] = (4*x - 1) * y[1] - y[2] + a[0].  Then p(x) = y[0].          //
//                                                                            //
//  Arguments:                                                                //
//     double x                                                               //
...
//        i.e. a[k] is the coefficient of W*[k](x).  Note that in the calling //
...
//                                                                            //
//     p = Chebyshev_Shifted_Wn_Series(x, a, deg);                            //
////////////////////////////////////////////////////////////////////////////////
double Chebyshev_Shifted_Wn_Series(double x, double a[], int degree)
{
   ...
   return (double) ((four_x_m2+1.0L) * yp1 - yp2 + (long double) a[0]);
}
