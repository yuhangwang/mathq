////////////////////////////////////////////////////////////////////////////////
// File: xlegendre_shifted_Pn_series.c                                        //
// Routine(s):                                                                //
//    xLegendre_Shifted_Pn_Series                                             //
////////////////////////////////////////////////////////////////////////////////
#define Clenshaw_Legendre_Step(alpha, pn1, gamma, pn2, a) \
                                               (alpha * pn1 - gamma * pn2 + a)
////////////////////////////////////////////////////////////////////////////////
// long double xLegendre_Shifted_Pn_Series(long double x, long double a[],    //
//                                                                int degree) //
//                                                                            //
//  Description:                                                              //
...
//                                                                            //
//     p = xLegendre_Shifted_Pn_Series(x, a, deg);                            //
////////////////////////////////////////////////////////////////////////////////
long double xLegendre_Shifted_Pn_Series(long double x, long double a[],
                                                                    int degree)
{
   ...
   for (k = degree; k >= 0; k--, yp2 = yp1, yp1 = y) {
      ...
      y = Clenshaw_Legendre_Step(alpha, yp1, kp1/kp2, yp2, a[k]);
   }
