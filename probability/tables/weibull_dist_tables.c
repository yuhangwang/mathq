////////////////////////////////////////////////////////////////////////////////
// File: weibull_dist_tables.c                                                //
// Routine(s):                                                                //
//    Weibull_Distribution_Tables                                             //
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
// void Weibull_Distribution_Tables( double a, double start, double delta,    //
...
//                                                                            //
//     Weibull_Distribution_Tables(a, start, delta, N, density,               //
                  ...
                  int nsteps, double *density, double* distribution_function)
{
   ...
   for (i = 0; i <= nsteps; i++) {
      if (x <= 0.0) {
         ...
         if (x < 0.0) density[i] = 0.0;
         else
            if (a > 1.0) density[i] = 0.0;
            else if (a < 1.0) density[i] = DBL_MAX;
            else density[i] = 1.0;
      }
      else {
         temp = exp(-pow(x,a));
         density[i] = a * pow(x, a-1.0) * temp;
         distribution_function[i] = 1.0 - temp;
      }
      x += delta;
   }
}
