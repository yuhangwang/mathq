...
////////////////////////////////////////////////////////////////////////////////
// long double xCharlier_Cn_Series(long double x, long double a,              //
...
//        routine c must be defined long double c[N] where N >= degree + 1.   //
//     int    degree                                                          //
...
//                                                                            //
//  Example:                                                                  //
//     long double x, a, c[N], p;                                             //
//     int    deg = N - 1;                                                    //
//                                                                            //
//     ( code to initialize x, a, and c[i] i = 0, ... , deg )                 //
//                                                                            //
//     p = xCharlier_Cn_Series(x, a, c, deg);                                 //
////////////////////////////////////////////////////////////////////////////////

long double xCharlier_Cn_Series(long double x, long double a, long double c[],
                                                                    int degree)
{
   ...
   for (k = degree; k >= 0; k--, yp2 = yp1, yp1 = y) 
      y = Clenshaw_Charlier_Step(amx, yp1, (long double) k, yp2, a, c[k]);
