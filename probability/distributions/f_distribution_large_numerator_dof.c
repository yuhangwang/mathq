////////////////////////////////////////////////////////////////////////////////
// File: f_distribution_large_numerator_dof.c                                 //
// Routine(s):                                                                //
//    F_Distribution_Large_Numerator_dof                                      //
////////////////////////////////////////////////////////////////////////////////
...
//                                                                            //
//     For a large number of numerator degrees of freedom, v1 >> 1, the       //
//     random variable                                                        //
//                              X = [ v2/F ]                                  //
//     has, approximately, a chi-square distribution with v2 degrees of       //
//     freedom and Pr[ F < f ] = 1 - Pr[ X < v2/f].                           //
//                                                                            //
...
//                integrand above.  Note v1 is assumed to be infinite and is  //
//                not used.                                                   //
...
//     int    v1, v2;                                                         //
//                                                                            //
//     p = F_Distribution_Large_Numerator_dof(x, v1, v2);                     //
////////////////////////////////////////////////////////////////////////////////

double F_Distribution_Large_Numerator_dof(double f, int v1, int v2)
{
   if ( f <= 0.0 ) return 0.0;

   return 1.0 - Chi_Square_Distribution( (double) v2 / f, v2 );
}
