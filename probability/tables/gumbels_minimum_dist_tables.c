////////////////////////////////////////////////////////////////////////////////
// File: gumbels_minimum_dist_tables.c                                        //
// Routine(s):                                                                //
//    Gumbels_Minimum_Distribution_Tables                                     //
////////////////////////////////////////////////////////////////////////////////

#include <math.h>                                   // required for exp()
                                    
////////////////////////////////////////////////////////////////////////////////
// void Gumbels_Minimum_Distribution_Tables( double start, double delta,      //
//               int nsteps, double *density, double* distribution_function)  //
//                                                                            //
//  Description:                                                              //
//     Gumbel's minimum extreme value distribution is the integral from -inf  //
...
//                                                                            //
//     Gumbels_Minimum_Distribution_Tables(start, delta, N, density,          //
                  ...
                  int nsteps, double *density, double* distribution_function)
{
   ...
   for (i = 0; i <= nsteps; i++) {
      ...
      distribution_function[i] = 1.0 - distribution_function[i];
      x += delta;
   }
}
