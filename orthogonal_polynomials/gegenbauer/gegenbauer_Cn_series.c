////////////////////////////////////////////////////////////////////////////////
// File: gegenbauer_Cn_series.c                                               //
// Routine(s):                                                                //
//    Gegenbauer_Cn_Series                                                    //
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
//                                                                            //
//     p = Gegenbauer_Cn_Series(x, alpha, a, deg);                            //
////////////////////////////////////////////////////////////////////////////////
...
double Gegenbauer_Cn_Series(double x, double alpha, double a[], int degree)
{
   ...
   for (k = degree; k >= 0; k--, yp2 = yp1, yp1 = y) {
      ...
      beta = ( ( (long double)k + k_two_alpha ) * (long double) x ) / kp1;
      gamma = k_two_alpha / kp2;
      y = beta * yp1 - gamma * yp2 + (long double) a[k];
   }
