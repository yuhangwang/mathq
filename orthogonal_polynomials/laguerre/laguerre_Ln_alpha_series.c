////////////////////////////////////////////////////////////////////////////////
// File: laguerre_Ln_alpha_series.c                                           //
// Routine(s):                                                                //
//    Laguerre_Ln_alpha_Series                                                //
////////////////////////////////////////////////////////////////////////////////
#define Clenshaw_Laguerre_Step(beta, ln1, kp1, akp1, kp2, ln2, a) \
                              ( (beta * ln1) / kp1 - (akp1 * ln2) / kp2 + a )
////////////////////////////////////////////////////////////////////////////////
// double Laguerre_Ln_alpha_Series(double x, double alpha, double a[],        //
//                                                               int degree)  //
//                                                                            //
//  Description:                                                              //
...
//        the calling routine a must be defined double a[N] where             //
//        N >= degree + 1.                                                    //
//     int    degree                                                          //
...
//                                                                            //
//  Example:                                                                  //
//     double x, alpha, a[N], p;                                              //
//     int    deg = N - 1;                                                    //
//                                                                            //
//     ( code to initialize x, alpha, and a[i] i = 0, ... , a[deg] )          //
//                                                                            //
//     p = Laguerre_Ln_alpha_Series(x, alpha, a, deg);                        //
////////////////////////////////////////////////////////////////////////////////
...
double Laguerre_Ln_alpha_Series(double x, double alpha, double a[], int degree)
{
   ...
   for (k = degree; k >= 0; k--, yp2 = yp1, yp1 = y) {
      kp1 = (long double) (k + 1);
      akp1 = (long double) alpha + kp1;
      kp2 = (long double) (k + 2);
      beta = ((long double)(k + k + 1) + (long double) alpha - (long double)x);
      y = Clenshaw_Laguerre_Step(beta, yp1, kp1, akp1, kp2, yp2,
                                                            (long double)a[k]);
   }
   return (double) y; 
}
